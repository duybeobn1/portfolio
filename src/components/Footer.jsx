...
function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/anh-vu-dev",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/anhvu_dev",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Full-Stack Developer passionate about creating intelligent solutions with AI, 
          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <a href="mailto:anh.vu@example.com" className="text-gray-300 hover:text-white transition-colors duration-200">
                  anh.vu@example.com
                </a>
              </div>
              <div className="flex items-center">
